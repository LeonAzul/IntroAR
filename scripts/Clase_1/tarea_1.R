...
vector_2 <- as.character(vector_2)
str(vector_2)
...
input <- "/home/lobo/Github/IntroAR/datos"
tarea <- "/home/lobo/Github/IntroAR/scripts/Clase_1/Tarea"
